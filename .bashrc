...
# the shells are not interactive and "source /home/user/.tc_bashrc.sh" is not
...
#   source ~/.bashrc
#
# See PR #122 on the AMIs repo for more details.
# ------------------------------------------------------------------------------
...
# ------------------------------------------------------------------------------
# After we disabled the "return" above the courses started failing because we
# have "set -e" and the /usr/share/bash-completion/bash_completion fails.
